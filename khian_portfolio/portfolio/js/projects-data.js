...
const projects = [
  {
    ...
    category: "E-Commerce",
    year: "2026",
    description: "A full-stack clothing e-commerce site with a product catalog, cart, and checkout flow.",
    longDescription:
  ...
  },
  {
    ...
    category: "Websites",
    year: "2026",
    description: "A multi-page portfolio site built collaboratively for the Digital Builders dev team.",
    longDescription:
